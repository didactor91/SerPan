  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx('h1', { className: 'text-2xl font-bold', children: project.name }),
          _jsxs('div', {
            className: 'space-x-2',
            children: [
              _jsx(Button, {
                onClick: () => healthMutation.mutate(),
                children: healthMutation.isPending ? 'Checking...' : 'Check Health',
              }),
              _jsx(Button, {
                onClick: () => restartMutation.mutate(),
                disabled: restartMutation.isPending,
                children: restartMutation.isPending ? 'Restarting...' : 'Restart All',
              }),
              _jsx(Button, {
                variant: 'destructive',
      ...
      _jsxs('div', {
        ...
        children: [
            ...
            children: [
              _jsx(CardHeader, {
                children: _jsxs('div', {
                  className: 'flex justify-between items-center',
                  children: [
                    _jsx(CardTitle, { children: 'Project Info' }),
                    !isEditing
                      ? _jsx(Button, {
                          size: 'sm',
                          variant: 'outline',
                      ...
                      : _jsxs('div', {
                          ...
                          children: [
                            _jsx(Button, { size: 'sm', onClick: handleSaveEdit, children: 'Save' }),
                            _jsx(Button, {
                              size: 'sm',
                              variant: 'ghost',
                ...
                children: _jsxs('div', {
                  ...
                  children: [
                    _jsxs('div', {
                      ...
                      children: [
                        _jsx('span', { className: 'text-muted-foreground', children: 'Status:' }),
                        _jsx(Badge, {
                    ...
                    _jsxs('div', {
                      className: 'flex items-center justify-between',
                      children: [
                        _jsx('span', { className: 'text-muted-foreground', children: 'Type:' }),
                        _jsx('span', { children: project.type }),
                      ],
                    }),
                    _jsxs('div', {
                      className: 'flex items-center justify-between',
                      children: [
                        _jsx('span', { className: 'text-muted-foreground', children: 'Path:' }),
                        _jsx('code', {
                    ...
                    _jsxs('div', {
                      className: 'flex items-center justify-between',
                      children: [
                        _jsx('span', { className: 'text-muted-foreground', children: 'Domain:' }),
                        isEditing
                          ? _jsx(Input, {
                              value: editedDomain,
                    ...
                    _jsxs('div', {
                      className: 'flex items-center justify-between',
                      children: [
                        _jsx('span', { className: 'text-muted-foreground', children: 'Port:' }),
                        isEditing
                          ? _jsx(Input, {
                              value: editedPort,
                    ...
                    project.lastHealthCheck &&
                      _jsxs('div', {
                        ...
                        children: [
                          ...
                          _jsx('span', { className: 'text-xs', children: project.lastHealthCheck }),
                        ],
                      }),
                  ],
                }),
          ...
          _jsxs(Card, {
            children: [
              _jsx(CardHeader, { children: _jsx(CardTitle, { children: 'System Resources' }) }),
              _jsx(CardContent, {
                children: _jsxs('div', {
                  className: 'space-y-2',
                  children: [
                    _jsx('p', {
                      ...
                      children: 'Project-specific resource usage:',
                    }),
                    processes.length === 0 && containers.length === 0
                      ? _jsx('p', {
                          className: 'text-muted-foreground text-sm',
                          children: 'No processes or containers found',
                        })
                      : _jsxs('div', {
                          className: 'space-y-2',
                          children: [
                              ...
                              _jsxs(
                                'div',
                                {
                                  ...
                                  children: [
                                    ...
                                    _jsx(Badge, {
                                      className: getStatusColor(proc.status),
                                ...
                                'div',
                                {
                                  ...
                                  children: [
                                    ...
                                    _jsx('div', {
                                      ...
                                      children: _jsx(Badge, {
                                        className: getStatusColor(container.state),
      ...
      _jsxs(Card, {
        children: [
          _jsx(CardHeader, { children: _jsx(CardTitle, { children: 'Containers' }) }),
          _jsx(CardContent, {
            children:
              containers.length === 0
                ? _jsx('p', {
                    className: 'text-muted-foreground text-sm',
                    children: 'No Docker containers found for this project',
                  })
                : _jsx('div', {
                    className: 'space-y-2',
                          ...
                          children: [
                            ...
                            _jsxs('div', {
                              ...
                              children: [
                                _jsxs('span', {
                                  className: 'text-xs',
                                  children: ['CPU: ', container.cpuPercent.toFixed(1), '%'],
                                }),
                                _jsxs('span', {
                                  className: 'text-xs',
                                  children: ['RAM: ', container.memoryUsage],
                                }),
                                _jsxs('span', {
                                  className: 'text-xs text-muted-foreground',
                                  children: ['Status: ', container.status],
                                }),
                              ],
                            }),
                            _jsxs('div', {
                              ...
                              children: [
                                _jsx(Button, {
                                  ...
                                  disabled:
                                    containerActionMutation.isPending || container.state === 'Up',
                                  children: 'Start',
                                }),
                                _jsx(Button, {
                                  size: 'sm',
          ...
          children: [
            _jsx(CardHeader, {
              children: _jsxs('div', {
                className: 'flex justify-between items-center',
                children: [
                  _jsxs(CardTitle, { children: ['Logs: ', selectedContainerLogs] }),
                  _jsx(Button, {
                    size: 'sm',
                    variant: 'ghost',
          ...
          _jsx(CardContent, {
            children:
              !logsData?.data?.logs || logsData.data.logs.length === 0
                ...
                : _jsx('div', {
                    className: 'bg-muted rounded p-4 font-mono text-xs overflow-auto max-h-64',
                    children: logsData.data.logs.map((line, i) =>
                      _jsx('div', { className: 'whitespace-pre-wrap', children: line }, i),
                    ),
                  }),
          }),
      ...
      _jsxs(Card, {
        children: [
          _jsx(CardHeader, { children: _jsx(CardTitle, { children: 'Instances' }) }),
          _jsx(CardContent, {
            children:
              instances.length === 0
                ? _jsx('p', {
                    className: 'text-muted-foreground text-sm',
                    children: 'No instances linked',
                  })
                : _jsx('div', {
                    className: 'space-y-2',
                        ...
                        'div',
                        {
                          ...
                          children: [
                            ...
                            instance.containerStatus &&
                              _jsx(Badge, {
                                className: getStatusColor(instance.containerStatus),
                                children: instance.containerStatus,
                              }),
                          ],
                        },
                        instance.id,
