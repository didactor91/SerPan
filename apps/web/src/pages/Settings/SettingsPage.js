...
export function SettingsPage() {
      ...
      const responseJson = {
        ...
        response: {
          clientDataJSON: uint8ArrayToBase64URL(
            new Uint8Array(credentialResponse.response.clientDataJSON),
          ),
          attestationObject: uint8ArrayToBase64URL(
            new Uint8Array(credentialResponse.response.attestationObject),
          ),
        },
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('h1', { className: 'text-2xl font-bold', children: 'Settings' }),
      _jsxs(Card, {
        children: [
          _jsx(CardHeader, { children: _jsx(CardTitle, { children: 'Passkeys' }) }),
          _jsxs(CardContent, {
            className: 'space-y-4',
            children: [
              _jsx('p', {
                className: 'text-sm text-muted-foreground',
                children: 'Passkeys allow you to log in without a password using WebAuthn (FIDO2).',
              }),
              isLoading
                ? _jsx('p', { className: 'text-sm', children: 'Loading passkeys...' })
                : passkeys.length === 0
                  ? _jsx('p', {
                      className: 'text-sm text-muted-foreground',
              ...
              _jsx('div', {
                ...
                children: _jsx(Button, {
                  ...
                  children: isRegistering ? 'Registering...' : 'Add Passkey',
                }),
              }),
            ],
          }),
